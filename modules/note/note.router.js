...
router.post("/add", auth(), validation(validator.addNoteValidate), noteController.addNote);
router.get("/notes", auth(), noteController.userNotes);
router.get("/notes/:id", auth(), validation(validator.NoteValidate), noteController.getNoteByID);
